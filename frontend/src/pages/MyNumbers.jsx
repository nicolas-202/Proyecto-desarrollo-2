...
function MyNumbers() {
  ...
  if (error) {
    return (
      <div className="module-container active">
        <div className="message error show">{error}</div>
      </div>
    );
  }
                ...
                >
                  ...
                  >
                    <div style={{ flex: 1 }}>
                      ...
                      >
                        <div style={{ fontSize: '2rem' }}>{getRifaIcon(group.raffle_name)}</div>
                        <div>
                          <h3
                            style={{
                              fontSize: '1.3rem',
              ...
              {wonRaffles.map(ticket => (
                ...
                >
                  ...
                  <div style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    >
                      <div style={{ fontSize: '3rem' }}>{getRifaIcon(ticket.raffle_name)}</div>
                      <div>
                        <h3 style={{ fontSize: '1.5rem', marginBottom: '0.25rem' }}>¡GANASTE!</h3>
