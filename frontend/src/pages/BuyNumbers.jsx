...
function BuyNumbers() {
  ...
  const handleNumberClick = (number, isAvailable) => {
    ...
    if (!isAuthenticated) {
      alert(
        '⚠️ Debes iniciar sesión para seleccionar números\n\nSerás redirigido a la página de autenticación.'
      );
      navigate('/auth');
      return;
    }
  ...
  if (error || !rifa) {
    return (
      <div className="module-container active">
        <div className="message error show">{error || 'Rifa no encontrada'}</div>
      ...
      <div className="rifa-details">
            ...
            >
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                ...
                <div>
                  ...
                  <br />${rifa.raffle_prize_amount?.toLocaleString()}
                </div>
              </div>
              <div
                style={{
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p style={{ margin: '0.5rem 0 0 0', opacity: 0.9 }}>Esta rifa ha sido cancelada</p>
              </div>
            </div>
            ...
            >
              ...
              >
                <p style={{ margin: '0.5rem 0' }}>
                  📋 <strong>Motivo:</strong> Esta rifa fue cancelada por el organizador o por
        ...
        >
          ...
          <div>
            ...
            <p>
              <strong>Descripción:</strong> {rifa.raffle_description}
            </p>
            <p>
              <strong>Premio:</strong> ${rifa.raffle_prize_amount?.toLocaleString()}
            </p>
            <p>
              <strong>Precio por número:</strong> ${rifa.raffle_number_price?.toLocaleString()}
            </p>
            <p>
              <strong>Total números:</strong> {rifa.raffle_number_amount}
            </p>
            <p>
              <strong>Números vendidos:</strong> {rifa.raffle_number_amount - numbersArray.length}
            </p>
            <p>
            ...
            <p>
              <strong>Creada por:</strong> {rifa.raffle_created_by?.first_name}{' '}
              {rifa.raffle_created_by?.last_name}
            </p>
          </div>
              ...
              {selectedNumbers.length > 0 ? (
                <>
                  ...
                  <p>
                    ...
                    {(selectedNumbers.length * Number(rifa.raffle_number_price)).toLocaleString()}
                  </p>
                </>
              ) : (
