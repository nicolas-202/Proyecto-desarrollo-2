...
class TicketListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return (
            ...
            .select_related("raffle", "payment_method")
            .order_by("-created_at")
        )
...
class RaffleTicketsView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return (
            Ticket.objects.filter(raffle_id=raffle_id)
...
class TicketRefundView(generics.UpdateAPIView):
    ...
    def update(self, request, *args, **kwargs):
        ...
        try:
            ...
            return Response(
                {"message": "Ticket reembolsado exitosamente", **ticket_info},
...
class UserTicketStatsView(generics.RetrieveAPIView):
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        active_tickets = Ticket.objects.filter(
            user=user, raffle__raffle_winner__isnull=True  # Rifas sin ganador aún
        ).count()
        ...
        return Response(
            {
                ...
                "win_rate": (
                    f"{(winning_tickets / total_tickets * 100):.1f}%"
                    if total_tickets > 0
                    else "0.0%"
                ),
            },
...
class UserTicketHistoryView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return (
            Ticket.objects.filter(user_id=user_id)
            .select_related("raffle", "payment_method", "user")
            .order_by("-created_at")
        )
