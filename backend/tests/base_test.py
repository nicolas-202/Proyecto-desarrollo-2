...
class BaseApiTest(
    ...
    def setUpTestData(cls):
        ...
        cls.document_type = DocumentType.objects.create(
            document_type_name="Cedula de Ciudadania", document_type_code="CC"
        )

        # Crear Country, State, City para usuarios
        test_country_for_city = Country.objects.create(
            country_name="Test Country for City", country_code="TC"
        )
        ...
        cls.test_city = City.objects.create(
            city_name="Test City", city_code="TC", city_state=test_state
        )
    ...
    def setUp(self):
        ...
        self.detail_url = reverse(
            self.url_detail_name, kwargs={"pk": self.test_object.pk}
        )
    ...
    def test_deactivate_as_admin(self):
        ...
        response = self.client.patch(
            self.detail_url, {is_active_field: False}, format="json"
        )
